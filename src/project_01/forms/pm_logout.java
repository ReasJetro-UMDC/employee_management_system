 ...
 * @author troy
 */
public class pm_logout extends javax.swing.JFrame {

    /**
     * Creates new form pm_logout
     */
    public pm_logout() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pm_logout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
